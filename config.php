...
return [
    ...
    'bot_username' => '<your telegram bot user name>', // Without "@"

    // [Manager Only] Secret key required to access the webhook
    'secret'       => 'a1b2c3d4e5f6g7h8i9',

    // When using the getUpdates method, this can be commented out
    'webhook'      => [
        'url' => 'https://your-telegram-bot-backend-domain/hook.php',
    ...
    'commands'     => [
        ...
        'configs' => [
            'subscribe' => [
                'allbridge_core_api_url' => '<self-hosted-allbridge-core-rest-api-url>'
            ],
    ...
    'admins'       => [
        000000000 // <--- Your telegram user ID
    ],
