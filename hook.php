...
Longman\TelegramBot\TelegramLog::initErrorLog(__DIR__ . "/hook.php");
Longman\TelegramBot\TelegramLog::initDebugLog(__DIR__ . "/hook.php");
Longman\TelegramBot\TelegramLog::initUpdateLog(__DIR__ . "/hook.php");
